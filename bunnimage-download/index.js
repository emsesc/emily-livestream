...
module.exports = async function (context, req, inputBlob) {
    ...
    var download = ""
    var downloadpng = "https://storageaccountdanieacaf.blob.core.windows.net/images/" + username + ".png";
    var downloadjpg = "https://storageaccountdanieacaf.blob.core.windows.net/images/" + username + ".jpeg";
